...
import { createGardenFixture, base, day } from "./garden-adventure-fixture.mjs";
...
try {
  ...
  await writeFile(`${out}/${mode}-results.json`, JSON.stringify({ state: "optimized test-only preview; isolated database and fixture auth/activity", day, results }, null, 2));
} catch (error) {
