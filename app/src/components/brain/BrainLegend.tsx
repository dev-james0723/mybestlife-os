...
export function BrainLegend({
  ...
  return (
    <div
      role="dialog"
      aria-label={b("Brain legend")}
      className={cn(
        "pointer-events-auto absolute inset-y-3 right-3 z-40 flex w-[min(20rem,calc(100%-1.5rem))] flex-col overflow-hidden rounded-2xl text-sm",
        graphT.legend.wrap,
      )}
    >
