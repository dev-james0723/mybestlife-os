export const osGlassPanelClassName =
  "relative overflow-hidden rounded-2xl border border-slate-300/60 bg-white/78 text-slate-950 shadow-[0_18px_56px_rgba(15,23,42,0.12),inset_0_1px_0_rgba(255,255,255,0.72)] backdrop-blur-xl backdrop-saturate-150 dark:border-white/12 dark:bg-white/[0.055] dark:text-white dark:shadow-[0_18px_56px_rgba(2,8,23,0.34),inset_0_1px_0_rgba(255,255,255,0.08)]";

export const osFrostedPanelClassName =
  "relative overflow-hidden rounded-2xl border border-slate-300/55 bg-white/70 text-slate-950 shadow-[0_12px_38px_rgba(15,23,42,0.1),inset_0_1px_0_rgba(255,255,255,0.7)] backdrop-blur-lg backdrop-saturate-150 dark:border-white/10 dark:bg-white/[0.055] dark:text-white dark:shadow-[0_12px_38px_rgba(2,8,23,0.24),inset_0_1px_0_rgba(255,255,255,0.07)]";

export const osSolidPanelClassName =
  "rounded-2xl border border-slate-200/80 bg-white/92 text-slate-950 shadow-[0_10px_30px_rgba(15,23,42,0.08)] dark:border-white/8 dark:bg-zinc-900/92 dark:text-white dark:shadow-[0_10px_30px_rgba(2,8,23,0.24)]";

export const osGlassControlClassName =
  "border border-slate-300/55 bg-white/72 text-slate-700 shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] backdrop-blur-xl backdrop-saturate-150 transition-[background,border-color,color,box-shadow] duration-150 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-slate-400/70 hover:bg-white/90 hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime-300/60 disabled:pointer-events-none disabled:opacity-45 motion-reduce:transition-none dark:border-white/12 dark:bg-white/[0.055] dark:text-white/78 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] dark:hover:border-white/22 dark:hover:bg-white/[0.085] dark:hover:text-white";

export const osPrimaryControlClassName =
  "bg-lime-300 text-slate-950 shadow-[0_10px_30px_rgba(190,242,100,0.16),inset_0_1px_0_rgba(255,255,255,0.42)] transition-[background,box-shadow] duration-150 ease-[cubic-bezier(0.16,1,0.3,1)] hover:bg-lime-200 focus-visible:ring-lime-300/55 disabled:pointer-events-none disabled:opacity-45 motion-reduce:transition-none";
