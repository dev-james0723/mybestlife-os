...
description: Bundled Mind Council lens (lens-ray-dalio). Source: jazzqi/ray-dalio-skill. 
license: See upstream repository
metadata:
  mindCouncilSkillId: lens-ray-dalio
  upstreamRepo: jazzqi/ray-dalio-skill
  upstreamUrl: https://raw.githubusercontent.com/jazzqi/ray-dalio-skill/main/SKILL.md
---
