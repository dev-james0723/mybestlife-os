...
const en: ProjectsUiCopy = {
  ...
  aiGeneratedMetadata: "Xiaoba's project draft",
  ...
  fillWithAi: "Ask Xiaoba to set up this project",
  aiSettingUp: "Xiaoba is setting up your project…",
  projectAiReady: "Xiaoba finished project setup.",
  addTaskManually: "Add task manually",
  aiSmartAddTask: "Ask Xiaoba to suggest a task",
...
const zhTW: ProjectsUiCopy = {
  ...
  aiGeneratedMetadata: "Xiaoba 的專案草稿",
  regenerate: "重新生成",
  uploadCustom: "上傳自訂",
  ...
  fillWithAi: "請 Xiaoba 幫你設定這個專案",
  aiSettingUp: "Xiaoba 正在設定你的專案⋯",
  projectAiReady: "Xiaoba 已完成專案設定。",
  addTaskManually: "手動添加任務",
  aiSmartAddTask: "請 Xiaoba 協助建議任務",
  descriptionLabel: "描述",
