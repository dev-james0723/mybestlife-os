...
const en: CalendarUiCopy = {
  ...
  tabWeek: "Week",
  tabMonth: "Month",
  tabAIPlan: "Schedule suggestions",
  ...
  backToAIPlan: "Back to Schedule suggestions",
  ...
  aiPlanTitle: "Schedule suggestions",
  aiGenerate: "Suggest starting steps",
  aiGenerating: "Calculating…",
  aiAcceptAll: "Mark all reviewed",
  aiReject: "Reject",
  aiAccept: "Mark reviewed",
  aiRationaleLabel: "Why:",
  aiConflictsTitle: "Conflicts & warnings",
  aiFreeWindowsTitle: "Free windows",
  aiEnergyArcTitle: "Energy arc",
  aiEmptyState: "Suggestions use your saved items and working hours. Reviewing a suggestion does not save it to your planner.",
...
const zhTW: DeepPartial<CalendarUiCopy> = {
  ...
  aiEmptyState: "點擊「建议起步时段」讓 AI 建議日程。",
  dayLoadLabels: {
    Light: "輕量",
    Balanced: "均衡",
    "Focus-heavy": "深度專注",
...
const zhCN: DeepPartial<CalendarUiCopy> = {
  ...
  aiEmptyState: "根据已记录的项目及工作时间提出建议。标记已查看不会保存到计划。",
  dayLoadLabels: {
    Light: "轻量",
    Balanced: "均衡",
    "Focus-heavy": "深度专注",
