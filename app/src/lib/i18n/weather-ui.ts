...
const it: DeepPartial<WeatherUiCopy> = {
  ...
  uvExtreme: "Estremo",
  aqiGood: "Buono",
  aqiModerate: "Moderato",
  aqiSensitive: "Sensibili",
  aqiUnhealthy: "Malsano",
  aqiVeryUnhealthy: "Molto malsano",
  aqiHazardous: "Pericoloso",
