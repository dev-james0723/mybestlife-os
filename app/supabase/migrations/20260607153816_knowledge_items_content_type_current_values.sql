-- Keep the legacy knowledge_items.content_type constraint aligned with the
-- app's current ContentType union. GitHub repository saves write
-- content_type = 'repository', and older databases rejected that value.
