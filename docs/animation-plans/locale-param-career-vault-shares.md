# Animation Plan: Career vault shares

## Route
`/[locale]/career/vault/shares`

## Page purpose
Supports the career vault shares workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/shares/page.tsx`
