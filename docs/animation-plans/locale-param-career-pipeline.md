# Animation Plan: Career pipeline

## Route
`/[locale]/career/pipeline`

## Page purpose
Supports the career pipeline workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/pipeline/page.tsx`
