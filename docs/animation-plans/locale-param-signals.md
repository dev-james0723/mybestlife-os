# Animation Plan: Signals

## Route
`/[locale]/signals`

## Page purpose
Surfaces ambient signals and feeds that influence life planning.
...
- `app/src/app/[locale]/(protected)/signals/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/signals/**`
