# Animation Plan: Grateful Things

## Route
`/[locale]/grateful-things`

## Page purpose
Captures gratitude entries and makes memory review feel warm.
...
reflective, warm, unhurried, and intimate.
...
- `app/src/app/[locale]/(protected)/grateful-things/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/grateful-things/**`
