# Animation Plan: Google Calendar

## Route
`/[locale]/google-calendar`

## Page purpose
Manages Google Calendar connection and sync status.
...
- `app/src/app/[locale]/(protected)/google-calendar/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/google-calendar/**`
