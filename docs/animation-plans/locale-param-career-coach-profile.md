# Animation Plan: Career coach profile

## Route
`/[locale]/career/coach/profile`

## Page purpose
Supports the career coach profile workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/coach/profile/page.tsx`
