# Animation Plan: Relationship

## Route
`/[locale]/relationship`

## Page purpose
Manages people, role-model reflections, and relationship intelligence.
...
- `app/src/app/[locale]/(protected)/relationship/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/relationship/**`
