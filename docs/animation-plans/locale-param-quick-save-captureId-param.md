# Animation Plan: Quick Save captureId

## Route
`/[locale]/quick-save/[captureId]`

## Page purpose
Completes the quick-save capture funnel from setup through detail and success states.
...
- `app/src/app/[locale]/(protected)/quick-save/[captureId]/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/quick-save/**`
