# Animation Plan: Career vault tags

## Route
`/[locale]/career/vault/tags`

## Page purpose
Supports the career vault tags workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/tags/page.tsx`
