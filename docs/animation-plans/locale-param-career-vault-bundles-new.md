# Animation Plan: Career vault bundles new

## Route
`/[locale]/career/vault/bundles/new`

## Page purpose
Supports the career vault bundles new workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/bundles/new/page.tsx`
