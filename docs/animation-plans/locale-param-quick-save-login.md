# Animation Plan: Quick Save Login

## Route
`/[locale]/quick-save-login`

## Page purpose
Lets users authenticate into the quick-save capture flow.
...
- `app/src/app/[locale]/quick-save-login/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/quick-save-login/**`
