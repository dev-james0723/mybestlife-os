# Animation Plan: Career vault fileId compare

## Route
`/[locale]/career/vault/[fileId]/compare`

## Page purpose
Supports the career vault fileid compare workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/[fileId]/compare/page.tsx`
