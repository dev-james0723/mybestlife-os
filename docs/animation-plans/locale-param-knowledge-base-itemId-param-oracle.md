# Animation Plan: Knowledge Base itemId oracle

## Route
`/[locale]/knowledge-base/[itemId]/oracle`

## Page purpose
Presents knowledge-source oracle detail while preserving reading and research focus.
...
- `app/src/app/[locale]/(protected)/knowledge-base/[itemId]/oracle/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/knowledge-base/**`
