# Animation Plan: Relationships

## Route
`/[locale]/relationships`

## Page purpose
Legacy or alternate relationship surface that should remain stable while the primary relationship hub is animated.
...
human, attentive, and emotionally clear.
...
- `app/src/app/[locale]/(protected)/relationships/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/relationships/**`
