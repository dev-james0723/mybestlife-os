# Animation Plan: Career coach promptId use

## Route
`/[locale]/career/coach/[promptId]/use`

## Page purpose
Supports the career coach promptid use workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/coach/[promptId]/use/page.tsx`
