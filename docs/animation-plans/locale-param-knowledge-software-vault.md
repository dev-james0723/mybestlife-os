# Animation Plan: Knowledge software Vault

## Route
`/[locale]/knowledge/software-vault`

## Page purpose
Nested knowledge tool surfaces, including software-vault compatibility routes.
...
- `app/src/app/[locale]/(protected)/knowledge/software-vault/page.tsx`
