# Animation Plan: Career compass

## Route
`/[locale]/career/compass`

## Page purpose
Supports the career compass workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/compass/page.tsx`
