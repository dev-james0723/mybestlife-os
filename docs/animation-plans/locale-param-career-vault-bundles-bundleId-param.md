# Animation Plan: Career vault bundles bundleId

## Route
`/[locale]/career/vault/bundles/[bundleId]`

## Page purpose
Supports the career vault bundles bundleid workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/bundles/[bundleId]/page.tsx`
