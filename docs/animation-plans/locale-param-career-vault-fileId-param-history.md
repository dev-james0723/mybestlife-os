# Animation Plan: Career vault fileId history

## Route
`/[locale]/career/vault/[fileId]/history`

## Page purpose
Supports the career vault fileid history workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/[fileId]/history/page.tsx`
