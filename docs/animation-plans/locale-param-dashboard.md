# Animation Plan: Dashboard

## Route
`/[locale]/dashboard`

## Page purpose
Gives the user an immediate command-center view of priorities, inspiration, urgent work, and current momentum.
...
focused, controlled, high-signal, and quietly confident.
