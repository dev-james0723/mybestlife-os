# Animation Plan: Career journal

## Route
`/[locale]/career/journal`

## Page purpose
Supports the career journal workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/journal/page.tsx`
