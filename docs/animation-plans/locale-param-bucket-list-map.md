# Animation Plan: Bucket List map

## Route
`/[locale]/bucket-list/map`

## Page purpose
Explores dreams, travel ideas, and life experiences.
...
aspirational, playful, and lightly cinematic.
...
- `app/src/components/bucket-list/**`
