# Animation Plan: Career vault fileId

## Route
`/[locale]/career/vault/[fileId]`

## Page purpose
Supports the career vault fileid workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/[fileId]/page.tsx`
