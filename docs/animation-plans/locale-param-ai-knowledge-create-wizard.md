# Animation Plan: Ai Knowledge create wizard

## Route
`/[locale]/ai-knowledge/create/wizard`

## Page purpose
Guides creation of AI prompt assets through modal, blank, or wizard flows.
...
- `app/src/app/[locale]/(protected)/ai-knowledge/create/wizard/page.tsx`
