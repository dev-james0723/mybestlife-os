# Animation Plan: Career vault bundles

## Route
`/[locale]/career/vault/bundles`

## Page purpose
Supports the career vault bundles workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/bundles/page.tsx`
