# Animation Plan: Career vault

## Route
`/[locale]/career/vault`

## Page purpose
Supports the career vault workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/vault/page.tsx`
