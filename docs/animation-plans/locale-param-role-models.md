# Animation Plan: Role Models

## Route
`/[locale]/role-models`

## Page purpose
Organizes role models and distilled behavior patterns.
...
- `app/src/app/[locale]/(protected)/role-models/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/role-models/**`
