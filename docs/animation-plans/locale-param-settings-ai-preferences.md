# Animation Plan: Settings ai Preferences

## Route
`/[locale]/settings/ai-preferences`

## Page purpose
Lets the user configure profile, AI preferences, voice, and app settings.
...
- `app/src/app/[locale]/(protected)/settings/ai-preferences/page.tsx`
