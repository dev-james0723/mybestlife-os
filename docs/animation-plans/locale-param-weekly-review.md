# Animation Plan: Weekly Review

## Route
`/[locale]/weekly-review`

## Page purpose
Guides reflection across the week and turns review into next actions.
...
- `app/src/app/[locale]/(protected)/weekly-review/page.tsx`
