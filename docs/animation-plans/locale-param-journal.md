# Animation Plan: Journal

## Route
`/[locale]/journal`

## Page purpose
Supports calm journaling, AI summaries, audio, and illustrations.
...
- `app/src/app/[locale]/(protected)/journal/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/journal/**`
