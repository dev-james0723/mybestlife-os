# Animation Plan: Os Buddy air Remote

## Route
`/[locale]/os-buddy/air-remote`

## Page purpose
Supports the os buddy air remote workflow inside the life OS.
...
- `app/src/app/[locale]/(protected)/os-buddy/air-remote/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/os-buddy/**`
