# Animation Plan: Career timeline

## Route
`/[locale]/career/timeline`

## Page purpose
Supports the career timeline workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/timeline/page.tsx`
