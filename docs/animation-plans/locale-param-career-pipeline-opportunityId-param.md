# Animation Plan: Career pipeline opportunityId

## Route
`/[locale]/career/pipeline/[opportunityId]`

## Page purpose
Supports the career pipeline opportunityid workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/pipeline/[opportunityId]/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/career/**`
- `app/src/components/career-*/**`
...
- SplitText only for a restrained hero/title reveal if typography remains accessible
