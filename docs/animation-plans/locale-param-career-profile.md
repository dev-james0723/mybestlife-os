# Animation Plan: Career profile

## Route
`/[locale]/career/profile`

## Page purpose
Supports the career profile workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/profile/page.tsx`
