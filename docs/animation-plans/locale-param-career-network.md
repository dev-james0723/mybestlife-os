# Animation Plan: Career network

## Route
`/[locale]/career/network`

## Page purpose
Supports the career network workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/network/page.tsx`
