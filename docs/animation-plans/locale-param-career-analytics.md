# Animation Plan: Career analytics

## Route
`/[locale]/career/analytics`

## Page purpose
Supports the career analytics workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/analytics/page.tsx`
