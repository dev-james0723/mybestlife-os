# Animation Plan: Youtube Radar

## Route
`/[locale]/youtube-radar`

## Page purpose
Tracks YouTube/radar inputs as knowledge or signal sources.
...
- `app/src/app/[locale]/(protected)/youtube-radar/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/youtube-radar/**`
