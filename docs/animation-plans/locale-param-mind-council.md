# Animation Plan: Mind Council

## Route
`/[locale]/mind-council`

## Page purpose
Creates a conversational council of thinking lenses and advisors.
...
- `app/src/app/[locale]/(protected)/mind-council/page.tsx`
- `app/src/components/motion/*`
- `app/src/lib/motion/*`
- `app/src/components/protected-scroll-layout.tsx`
- `app/src/components/mind-council/**`
