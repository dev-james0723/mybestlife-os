# Animation Plan: Daily Planner

## Route
`/[locale]/daily-planner`

## Page purpose
Helps the user plan the day, import tasks, review time blocks, and manage schedule changes.
...
- `app/src/components/daily-planner/**`
