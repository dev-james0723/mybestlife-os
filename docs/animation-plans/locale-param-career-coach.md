# Animation Plan: Career coach

## Route
`/[locale]/career/coach`

## Page purpose
Supports the career coach workflow while keeping the wider career suite coherent.
...
- `app/src/app/[locale]/(protected)/career/coach/page.tsx`
